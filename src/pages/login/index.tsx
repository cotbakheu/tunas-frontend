    ...
    <div className="min-h-screen flex justify-center items-center">
      <div className="w-10/12 md:w-3/12">
        <div className="mb-10 text-center">
          <h1 className="text-grey dark:text-grey-300 font-semibold text-4xl">
            Welcome To CROT
          </h1>
        </div>
        <Card style={{ height: "fit-content" }}>
          <form onSubmit={handleSubmit(handleSubmitData)}>
            ...
            <div className="mt-4">
              <Button
                type="submit"
                className="bg-primary dark:bg-primary hover:bg-primary-800 w-full"
              >
                Login
              </Button>
            </div>
        ...
        <div className="mt-4 text-center">
          <p className="inline text-sm font-medium text-textColor-primary-dark dark:text-grey-300">
            New to CROT?{" "}
          </p>
